...
function ModalEditTech({techTitle, id ,showModalEdit, setShowModalEdit}) {
    ...
    return (
        <S.Container showModalEdit={showModalEdit}>
            <S.Header>
                ...
                <svg onClick={()=>setShowModalEdit("")} width="11" height="13" viewBox="0 0 11 13" fill="none" xmlns="http://www.w3.org/2000/svg">
